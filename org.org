...
** TODO Frontend: Floor selector + metric picker + hover tooltip
...
- [ ] Create Pydantic models matching the contract (BuildingLayout, MetricsUpdate)
- [ ] Hardcode a sample building (3 floors, 4-6 rooms each, polygons in meters)
- [ ] Implement =GET /building= endpoint returning the sample building
- [ ] Test with curl / browser that the JSON looks right
** Saturday morning
*** Dany (Frontend)
