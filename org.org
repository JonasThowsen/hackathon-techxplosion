...
Rooms are axis-aligned rectangles defined by =x=, =y=, =w=, =h= in meters.
  ...
  "floors": [
    {
      ...
      "label": "Floor 1",
      "rooms": [
        { "id": "r-101", "name": "Lobby",    "x": 0.0,  "y": 0.0, "w": 10.0, "h": 9.0 },
        { "id": "r-102", "name": "Room 102", "x": 10.0, "y": 0.0, "w": 10.0, "h": 9.0 },
        { "id": "r-103", "name": "Kitchen",  "x": 0.0,  "y": 9.0, "w": 15.0, "h": 9.0 }
      ]
    },
    {
      "floor_index": 1,
      "label": "Floor 2",
      "rooms": [
        { "id": "r-201", "name": "Room 201", "x": 0.0,  "y": 0.0, "w": 15.0, "h": 9.0 },
        { "id": "r-202", "name": "Room 202", "x": 15.0, "y": 0.0, "w": 15.0, "h": 9.0 }
      ]
    }
  ]
}
...
|-------------------+-----------------+--------------------------------+-------------------|
| Building geometry | =GET /building= | rooms as =(x,y,w,h)= in meters | once on page load |
